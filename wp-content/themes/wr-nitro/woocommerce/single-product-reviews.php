				...
				<?php
					...
					$comment_form = array(
						...
						'fields'               => array(
							...
							'email'  => '<p class="comment-form-email"><label for="email"><input placeholder="' . esc_attr__( 'Email', 'wr-nitro' ) . '" id="email" name="email" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30" aria-required="true" /></p>',
						),
