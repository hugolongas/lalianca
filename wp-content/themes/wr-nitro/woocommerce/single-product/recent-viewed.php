...
if ( $products->have_posts() && $count > 1 ) : ?>
	<div class="p-recent-viewed mgt60 mgb30">
		...
		<div class="products grid <?php if ( $count > $limit ) echo 'wr-nitro-carousel' ;?>" data-owl-options='{"items": "<?php echo ( int ) $limit; ?>"<?php echo ( $wr_nitro_options['rtl'] ? ',"rtl": "true"' : '' ); ?>, "tablet":"2","mobile":"1" }'>
