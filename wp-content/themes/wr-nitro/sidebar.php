...
<div class="primary-sidebar <?php if ( $wr_sticky == true ) echo 'primary-sidebar-sticky'; ?> widget-style-<?php echo esc_attr( $wr_style ) . ' ' . ( is_customize_preview() ? 'customizable customize-section-widget_styles ' . $wr_sidebar_border : '' ); ?>">
