...
class WR_Nitro_Widgets_Subscription extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		$output = '<div id="' . esc_attr( $id ) . '" class="' . esc_attr( implode(' ', $classes ) ) . '">';
			$output .= '<form target="_blank" class="validate" name="mc-embedded-subscribe-form" method="post" action="' . esc_url( $link ) . '">';
			...
			if ( ! empty( $width ) ) {
				$output .= '
					#' . esc_attr( $id ) . '.sc-subscribe-form form {
						width: ' . ( ! empty( $width ) ? esc_attr( $width ) : '100%' ) . ';
					}
				';
			}
			if ( ! empty( $input_bg ) ) {
	...
	function form( $instance ) {
		...
		<p>
			...
			<input class="widget-color-picker" type="text" id="<?php echo $this->get_field_id( 'input_bg' ); ?>" name="<?php echo $this->get_field_name( 'input_bg' ); ?>" value="<?php echo esc_attr( $instance[ 'input_bg' ] ); ?>" />
		</p>
		<p>
		...
		<div class="icons-group" <?php echo ( 'icon-submit' == $instance['button_type'] ) ? 'style="display: block"' : 'style="display: none"'; ?>>
			...
			<p>
				...
				<input class="widget-color-picker" type="text" id="<?php echo $this->get_field_id( 'icon_color' ); ?>" name="<?php echo $this->get_field_name( 'icon_color' ); ?>" value="<?php echo esc_attr( $instance[ 'icon_color' ] ); ?>" />
			</p>
		</div>
		<div class="btn-group" <?php echo ( 'button-submit' == $instance['button_type'] ) ? 'style="display: block"' : 'style="display: none"'; ?>>
			...
			<p>
				...
				<input class="widget-color-picker" type="text" id="<?php echo $this->get_field_id( 'bg_color' ); ?>" name="<?php echo $this->get_field_name( 'bg_color' ); ?>" value="<?php echo esc_attr( $instance[ 'bg_color' ] ); ?>" />
			</p>
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'text_color' ) ); ?>"><?php esc_html_e( 'Button Text Color:', 'wr-nitro' ); ?></label><br>
				<input class="widget-color-picker" type="text" id="<?php echo $this->get_field_id( 'text_color' ); ?>" name="<?php echo $this->get_field_name( 'text_color' ); ?>" value="<?php echo esc_attr( $instance[ 'text_color' ] ); ?>" />
			</p>
		</div>
		...
		<p>
			...
			<input class="widget-color-picker" type="text" id="<?php echo $this->get_field_id( 'border_color' ); ?>" name="<?php echo $this->get_field_name( 'border_color' ); ?>" value="<?php echo esc_attr( $instance[ 'border_color' ] ); ?>" />
		</p>
		<p>
