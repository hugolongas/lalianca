					...
					<?php if ( $package['main'] ) { ?>
						...
						<div class="main-demo-content">
							...
							<div class="btn-install-demo">
								<a target="_blank" href="<?php echo esc_url( $package['demo'] ); ?>" class="button button-preview"><?php esc_html_e( 'Preview', 'wr-nitro' ); ?></a>
	...
	protected static function plugins_html( $registered ) {
		...
		<div id="plugins" class="tab-pane" role="tabpanel">
			...
			<div class="welcome-panel panel-small">
				...
				<?php
					if ( $registered ) {
						echo sprintf( '<a target="_blank" class="button button-primary install-all-plugin" href="%s">' . __( 'Install All Recommended Plugins', 'wr-nitro' ) . '</a>', admin_url( 'admin.php?page=tgmpa-install-plugins&plugin_status=install' ) );
					}
				?>
			</div>
			<?php endif; ?>
		...
		<div id="support" class="tab-pane" role="tabpanel">
			<div class="three-col">
				<div class="col">
					...
					<a target="_blank" href="http://nitro.woorockets.com/docs" class="button button-primary"><?php esc_html_e( 'Read Documentation', 'wr-nitro' ); ?></a>
				</div>
