...
$wr_is_woocommerce_active = is_plugin_active( 'woocommerce/woocommerce.php' );
			...
			<div class="hb-columns hb-clear">
				<div class="hb-column row-container">
					<div class="hb-items">
						...
						<?php if( $wr_is_woocommerce_active && is_plugin_active( 'wr-currency/main.php' ) ) { ?>
						...
						<?php if( $wr_is_woocommerce_active && $wr_nitro_options['wc_general_wishlist'] == 1 && ( is_plugin_active( 'yith-woocommerce-wishlist/init.php' ) || is_plugin_active( 'yith-woocommerce-wishlist-premium/init.php' ) ) ) { ?>
