...
// WR live search
$wr_is_live_search_activated = is_plugin_active( 'wr-live-search/main.php' );

// WR Currency
$wr_is_currency_activated = is_plugin_active( 'wr-currency/main.php' );
								...
								<div class="wr-customize-font" data-link-font-weight="textSettings-fontWeight">
									...
									<div class="wr-select-image-container">
										...
										<ul class="wr-list-font">
											<?php foreach ( WR_Nitro_Helper::google_fonts() as $font => $weight ) { ?>
...
<?php echo '<scr' . 'ipt>'; ?>
	jQuery(function($) {
		$(window).load(function () {
			...
			window.active_wrls = <?php echo ( $wr_is_live_search_activated ? 1 : 0 ); ?>;

			$( '.wr-save-header' ).prop( 'disabled', true );

			window.headerData = <?php echo ( isset( $wr_nitro_header_data['post_content'] ) && $wr_nitro_header_data['post_content'] ) ? ( is_serialized( $wr_nitro_header_data['post_content'] ) ? json_encode( unserialize( $wr_nitro_header_data['post_content'] ), true ) : $wr_nitro_header_data['post_content']  ) : '"{}"'; ?>;
