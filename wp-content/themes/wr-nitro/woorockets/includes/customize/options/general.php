...
class WR_Nitro_Customize_Options_General {
	public static function get() {
		return array(
			...
			'description' => '<a target="_blank" href="http://nitro.woorockets.com/docs/document/general"><span class="fa fa-question-circle has-tip" title="View Documentation for this section"></span></a>',
			'priority'    => 10,
			'sections'    => array(
				'site_identity' => array(
