...
class WR_Nitro_Customize_Options_Typography {
	public static function get() {
		return array(
			...
			'description' => '<a target="_blank" href="http://nitro.woorockets.com/docs/document/typography"><span class="fa fa-question-circle has-tip" title="View Documentation for this section"></span></a>',
			'priority'    => 12,
			'sections' => array(
				'typo_general' => array(
