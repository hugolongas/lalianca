...
class WR_Nitro_Customize_Options_Color_Schemes {
	public static function get() {
		return array(
			...
			'description' => '<a target="_blank" href="http://nitro.woorockets.com/docs/document/color"><span class="fa fa-question-circle has-tip" title="View Documentation for this section"></span></a>',
			'priority'    => 13,
			'sections' => array(
				'color_general' => array(
