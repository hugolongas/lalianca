...
class WR_Nitro_Customize_Options_Footer {
	public static function get() {
		return array(
			...
			'description' => '<a target="_blank" href="http://nitro.woorockets.com/docs/document/footer"><span class="fa fa-question-circle has-tip" title="View Documentation for this section"></span></a>',
			'type'        => 'option',
			'priority'    => 80,
			'settings'    => array(
			...
			'controls' => array(
				...
				'footer_layout' => array(
					...
					'description' => sprintf( __( 'Select the layout type for the footer. The content is added via Appearance <a target="_blank" href="%s">Widgets</a>.', 'wr-nitro' ), admin_url( 'widgets.php' ) ),
					'section'     => 'footer',
