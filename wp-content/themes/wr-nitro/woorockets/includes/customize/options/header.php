	...
	public static function get() {
		...
		if ( $header_layout ) {
			$theme_options = array(
					...
					'description' => sprintf( __( 'With Nitro theme, you can build an unlimited amount of unique header styles. The "magic" happens via the section <b><a target="_blank" href="%1$s">Manage Headers</a></b>.', 'wr-nitro' ), esc_url( admin_url( 'edit.php?post_type=header_builder' ) ) ) . '<a class="link-doc-header" target="_blank" href="http://nitro.woorockets.com/docs/document/footer"><span class="fa fa-question-circle has-tip" title="View Documentation for this section"></span></a>',
					'type'        => 'option',
					'priority'    => 20,
					'settings'    => array(
							'header_layout' => array(
			...
			$theme_options = array(
					...
					'controls' => array(
							'no_header_found' => array(
									'label'   => sprintf( __( 'No header was found on your site. Ready to publish your first header? <a target="_blank" href="%1$s">Get started here</a>.', 'wr-nitro' ), esc_url( admin_url( 'edit.php?post_type=header_builder' ) ) ),
									'section' => 'header',
