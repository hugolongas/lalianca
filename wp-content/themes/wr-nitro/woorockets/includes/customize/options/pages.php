...
class WR_Nitro_Customize_Options_Pages {
	public static function get() {
		return array(
			...
			'description' => '<a target="_blank" href="http://nitro.woorockets.com/docs/document/pages"><span class="fa fa-question-circle has-tip" title="View Documentation for this section"></span></a>',
			'priority'    => 60,
			'sections'    => array(
				'page' => array(
					'title'       => esc_html__( 'Standard Page', 'wr-nitro' ),
					'description' => '<div class="section-override"><span class="dashicons dashicons-warning"></span>' . esc_html__( 'Parameters in this section are overridden by the ones set in page options and will have no effect on preview area on the right.', 'wr-nitro' ) . '</div>',
					'settings'    => array(
				...
				'page_404' => array(
					...
					'description' => '<div style="margin-bottom: 40px;">' . sprintf( __( 'We have build nice "404" page for you. <a target="_blank" href="%1$s">Take a look</a>.', 'wr-nitro' ), esc_url( home_url( '?p=404404' ) ) ) . '</div>',
					'settings'    => array(
