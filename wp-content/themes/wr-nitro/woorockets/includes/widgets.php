...
class WR_Nitro_Widgets {
	...
	public static function admin_enqueue_scripts() {
		...
		if ( 'widgets.php' == $pagenow ) {
			...
			// Enqueue Select2.
			wp_enqueue_style( 'wr-select2', get_template_directory_uri() . '/assets/3rd-party/select2/select2.css' );
	...
	public static function admin_print_footer_scripts() {
		...
		<style type="text/css">
			...
			.wr-nitro-widget-assignment-target-item .dashicons {
				visibility: hidden;
			}
			.wr-nitro-widget-assignment-target-item.selected .dashicons {
				visibility: visible;
			}
		</style>
	...
	public static function search_target() {
		...
		// Make sure keyword not empty and has at least 3 characters.
	...
	public static function register() {
		...
		register_widget( 'WR_Nitro_Widgets_Subscription' );
		register_widget( 'WR_Nitro_Widgets_Social' );
	}
