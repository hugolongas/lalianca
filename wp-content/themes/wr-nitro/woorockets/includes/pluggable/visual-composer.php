	...
	public static function map_shortcode() {
			...
			array(
				...
				'params'          => array(
					array(
						...
						'description' => sprintf( __( 'Get a <a target="_blank" href="%s">API key</a></a>', 'wr-nitro' ), 'https://developers.google.com/maps/documentation/javascript/get-api-key' ),
						'type'             => 'textfield',
				...
				array(
					...
					'params' => array(
						...
						array(
							...
							'std'         => 'date',
							'save_always' => true,
							'description' => sprintf( __( 'Select how to sort retrieved products. More at %s.', 'wr-nitro' ), '<a href="http://codex.wordpress.org/Class_Reference/WP_Query#Order_.26_Orderby_Parameters" target="_blank">WordPress codex page</a>' ),
						),
						array(
							'type'        => 'dropdown',
							'heading'     => esc_html__( 'Sort order', 'wr-nitro' ),
							...
							'std'         => 'ASC',
							'save_always' => true,
							'description' => sprintf( __( 'Designates the ascending or descending order. More at %s.', 'wr-nitro' ), '<a href="http://codex.wordpress.org/Class_Reference/WP_Query#Order_.26_Orderby_Parameters" target="_blank">WordPress codex page</a>' ),
						),
						array(
							'type'        => 'dropdown',
				...
				array(
					...
					'params'   		=> array(
						...
						array(
							...
							'std'         => 'date',
							'save_always' => true,
							'description' => sprintf( __( 'Select how to sort retrieved products. More at %s. Default by Title', 'wr-nitro' ), '<a href="http://codex.wordpress.org/Class_Reference/WP_Query#Order_.26_Orderby_Parameters" target="_blank">WordPress codex page</a>' ),
							'dependency'  => array(
								'element' => 'order_fillter',
								'value'	  => array( 'all', 'featured', 'sale', 'top_rated' ),
							),
						...
						array(
							...
							'std'         => 'ASC',
							'save_always' => true,
							'description' => sprintf( __( 'Designates the ascending or descending order. More at %s. Default by ASC', 'wr-nitro' ), '<a href="http://codex.wordpress.org/Class_Reference/WP_Query#Order_.26_Orderby_Parameters" target="_blank">WordPress codex page</a>' ),
							'dependency'  => array(
								'element' => 'order_fillter',
								'value'   => array( 'all', 'featured', 'sale', 'top_rated' ),
							),
		...
		vc_map(
			array(
				...
				'icon'                    => 'fa fa-sliders',
				'base'                    => 'nitro_carousel',
				'as_parent'               => array( 'only' => 'nitro_banner, nitro_product, nitro_gallery_single, vc_single_image' ),
				'content_element'         => true,
				'show_settings_on_create' => true,
				'js_view'                 => 'VcColumnView',
				'params'                  => array(
			...
			array(
				...
				'params'   => array(
					...
					array(
						...
						'description' => sprintf( __( 'Lookup User ID for <a target="_blank" href="%s">Instagram</a> - <a target="_blank" href="%s">Flickr</a>', 'wr-nitro' ), 'https://smashballoon.com/instagram-feed/find-instagram-user-id/', 'http://idgettr.com/' ),
						'type'        => 'textfield',
						'admin_label' => true,
					),
					array(
						...
						'description' => sprintf( __( 'Generate Access Token <a target="_blank" href="%s">Instagram</a>', 'wr-nitro' ), 'http://instagram.pixelunion.net/'),
						'type'        => 'textfield',
						'dependency' => array(
							'element' => 'network',
							'value'   => 'instagram',
