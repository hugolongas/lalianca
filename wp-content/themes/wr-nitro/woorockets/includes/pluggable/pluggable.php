	...
	public static function tgmpa_register( $all = false ) {
		...
		if ( ! isset( self::$plugins ) ) {
			self::$plugins = array(
				...
				'wr-content-migration' => array(
					'name'               => 'Content Migration',
					'slug'               => 'wr-content-migration',
					'thumb'              => 'http://www.woorockets.com/files/plugins/wr-content-migration.png',
					'source'             => 'http://www.woorockets.com/files/plugins/wr-content-migration.zip',
					'source_type'        => 'external',
					'version'            => '1.0.0',
					'required'           => false,
					'force_activation'   => false,
