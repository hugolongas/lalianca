...
?>
<div class="site-title style-2 pr <?php echo esc_attr( implode( ' ', $wr_classes ) ) . ' ' . ( is_customize_preview() ? 'customizable customize-section-page_title ' : '' ); ?>" <?php echo implode( '', $wr_attr ); ?>>
