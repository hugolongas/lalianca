...
$wr_classes = array( 'b-classic mgt30 mgb30' );
	...
	<div class="<?php echo esc_attr( implode( ' ', $wr_classes ) ); ?>">
		...
		<?php while ( have_posts() ) : the_post(); ?>
			...
			<?php
				...
				if ( ( false === $wr_format ) || 'video' == $wr_format ) $wr_format = 'standard';
			?>

			<article id="post-<?php the_ID(); ?>" <?php post_class( 'mgb30 oh pr' ); ?> >

				<?php WR_Nitro_Render::get_template( 'blog/format/' . $wr_format . '' ); ?>

				<div class="entry-content oh <?php if ( 'boxed' == $wr_color ) echo esc_attr( 'pd20 overlay_bg' ); ?>">
