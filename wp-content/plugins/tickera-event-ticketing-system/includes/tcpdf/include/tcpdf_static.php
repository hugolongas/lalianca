...
// ====================================================================================================================
    ...
    public static function fileGetContents($file) {
        ...
        foreach ($alt as $path) {
            ...
            //original: if ( !ini_get( 'allow_url_fopen' ) && function_exists( 'curl_init' ) && preg_match( '%^(https?|ftp)://%', $path )
            if (/*function_exists('curl_init') && */preg_match('%^(https?|ftp)://%', $path)
            ) {
...
// try to get remote file data using cURL
               /* $crs = curl_init();
                ...
                curl_setopt($crs, CURLOPT_CONNECTTIMEOUT, 120);
                curl_setopt($crs, CURLOPT_TIMEOUT, 120);
